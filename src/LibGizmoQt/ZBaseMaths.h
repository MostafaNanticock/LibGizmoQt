...
public:
	...
	tmatrix(float m00, float m01, float m02, float m03, float m10, float m11, float m12, float m13, float m20, float m21, float m22, float m23, float m30, float m31, float m32, float m33);
	// casting operators
	operator float* ();
	operator const float* () const;
	...
	// Member Functions
	inline void Set(const float m11, const float m12, const float m13, const float m14, const float m21, const float m22, const float m23, const float m24, const float m31, const float m32, const float m33, const float m34, const float m41, const float m42, const float m43, const float m44);
...
public:
	...
	{
		if (MathFloatIsVeryClose(r, srcQuat.r) && MathFloatIsVeryClose(g, srcQuat.g) && MathFloatIsVeryClose(b, srcQuat.b) && MathFloatIsVeryClose(a, srcQuat.a))
			return true;
